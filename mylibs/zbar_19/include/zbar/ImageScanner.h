...
public:
    ...
    int scan (Image& image, int centerPos[][10])
    {
        return(zbar_scan_image(_scanner, image, centerPos));
    }

	int myscan(Image& image, int myDensity)
    {
        return(myzbar_scan_image(_scanner, image, myDensity));
    }
